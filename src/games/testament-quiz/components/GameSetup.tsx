...
import { ManualModel } from '../../testament-quiz/components/quizmanualmodel';
...
export const GameSetup: React.FC<GameSetupProps> = ({ onGameStart }) => {
  ...
  const [packType, setPackType] = useState<'books' | 'stories'>('books'); // Assuming the packType can be books or stories
